...
public interface TestConstants {
    ...
    String DEFAULT_NEWS_UUID = "DEFAULT NEWS UUID";
    Long DEFAULT_UID = 2L;
    String DEFAULT_NEWS_TITLE = "DEFAULT NEWS TITLE";
    String DEFAULT_NEWS_TEXT = "DEFAULT NEWS TEXT";
    String DEFAULT_TEST_SERVER_UUID = "DEFAULT TEST SERVER UUID";
    ...
    String DEFAULT_INSTANT_EXPECTED = "2014-12-22T10:15:30Z";
