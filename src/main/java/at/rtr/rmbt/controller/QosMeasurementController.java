...
public class QosMeasurementController {
    ...
    public MeasurementQosResponse provideMeasurementQosParameters(HttpServletRequest httpServletRequest) {
        return qosMeasurementService.getQosParameters(httpServletRequest);
    }
}
