 ...
 ******************************************************************************/
package at.rtr.rmbt.utils.hstoreparser;

import at.rtr.rmbt.exception.HstoreParseException;
import at.rtr.rmbt.utils.hstoreparser.annotation.HstoreCast;
...
public class HstoreParser<T> {
    private static final Logger logger = LoggerFactory.getLogger(HstoreParser.class);
    ...
    public T fromJson(JSONObject json) throws HstoreParseException {
        ...
        while (jsonKeys.hasNext()) {
            ...
            if (fieldsWithKeys.containsKey(key)) {
                ...
                try {
                ...
                } catch (IllegalAccessException | IllegalArgumentException | JSONException | InstantiationException e) {
                    ...
                    logger.error("field: " + field.toString() + ", key: " + key, e);
                }
            }
        }
